...
const fullscreenBtn = document.getElementById("expand-btn");
...
function toggleFullscreen() {
  !fullscreenflag ? openFullscreen(player) : closeFullscreen();
